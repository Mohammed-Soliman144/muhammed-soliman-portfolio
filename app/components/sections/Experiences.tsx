...
export default function Experiences(){
    ...
    return <section id='experiences' className="experience-section">
        <div className='container py-32 grid grid-cols-1 xl:grid-cols-2 gap-x-12 space-y-20 overlay-experiences'>
